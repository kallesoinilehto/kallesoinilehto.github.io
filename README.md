<html>  
  ...
  <p>Olen opiskellut useita ohjelmointikieliä mm. python ja C#. Minulla on takana lukuisia peliprojekteja, joista yksi oli 2D-peli (Godot) ja kaksi 3D-peliä (Unity ja Unreal Engine). Minulla on kokemusta myös 3d-mallinnuksesta sekä tulostuksesta.</p>
