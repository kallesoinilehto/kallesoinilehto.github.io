<html>  
  ...
  <p>Olen opiskellut useita ohjelmointikieliä mm. python ja C#. Minulla on takana lukuisia peliprojekteja, joista yksi oli 2D-peli (Godot) ja kaksi 3D-peliä (Unity ja Unreal Engine). Minulla on myös kokemusta 3d-mallinnuksesta sekä tulostuksesta. Sen lisäksi kokemusta löytyy myös media-alalta; hallitsen kuvakäsikirjoitukset, videoeditoinnin, valokuvauksen, äänityksen, haastattelut ja kuvanmuokkauksen. </p>
